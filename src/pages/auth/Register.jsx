    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-surface-container-lowest border border-outline-variant/30 rounded-3xl p-8 shadow-card-soft space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="font-headline-xl text-2xl text-primary tracking-tight">Create an Account</h1>
          <p className="text-body-sm text-on-surface-variant">Join PioMart for exclusive drops, order tracking, and VIP member perks.</p>
        </div>
        ...
        <button
          ...
          className="w-full bg-surface-container-low hover:bg-surface-variant border border-outline-variant/40 text-on-surface font-label-md py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-all duration-200 shadow-sm hover:shadow active:scale-98"
        >
